...
@Component
public class ClientsReplyListener {

    private final SendToPaymentsUseCase sendToPayments;

    public ClientsReplyListener(SendToPaymentsUseCase sendToPayments) {
        this.sendToPayments = sendToPayments;
    }

    @RabbitListener(queues = RoutingKeys.CLIENTS_ORCHESTRATOR_QUEUE)
