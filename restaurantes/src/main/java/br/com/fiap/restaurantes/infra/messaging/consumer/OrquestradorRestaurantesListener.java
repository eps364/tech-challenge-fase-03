package br.com.fiap.restaurantes.infra.messaging.consumer;

import br.com.fiap.restaurantes.core.dto.MensagemFila;
import br.com.fiap.restaurantes.core.gateway.QueuePublisherPort;
import br.com.fiap.restaurantes.core.usecase.processar_requisicao_orquestrador.ProcessarRequisicaoOrquestradorUseCase;
import br.com.fiap.restaurantes.infra.config.RabbitQueuesProperties;
import br.com.fiap.restaurantes.infra.messaging.mapper.MensagemMapper;
